...
<?php include(VIEWS_PATH."nav.php"); ?>
    <div class = "modal">
          <div class = "modal-body">
               ...
               <?php if($flag){?>
                <a class="btn-list-pet" href="<?php echo FRONT_ROOT ?>Keeper/showDashboardView">Enter to System</a>
            <?php }else{?>
                <a class="btn-list-pet" href="<?php echo FRONT_ROOT ?>Keeper/showRegistrationView">Try Again</a>
               <?php }?>
          </div>
    </div>
</body>
