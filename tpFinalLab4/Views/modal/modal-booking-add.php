...
<?php include(VIEWS_PATH."nav.php"); ?>
    <div class = "modal">
          <div class = "modal-body">
               ...
               <?php if($flag){?>
                <a class="btn-list-pet" href="<?php echo FRONT_ROOT ?>Booking/ShowListOwnerView">Accept</a>
            <?php }else{?>
                <a class="btn-list-pet" href="<?php echo FRONT_ROOT ?>Keeper/changeDataKeeperView">Cancel</a>
               <?php }?>
          </div>
    </div>
</body>