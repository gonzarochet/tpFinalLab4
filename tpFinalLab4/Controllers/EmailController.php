...
use Services\PHPMailer\SMTP as SMTP;
...
class EmailController
{
    ...
    public function Add($bookingNr)
    {
        ...
        try{
            ...
            $this->mail->Body = 'Reserva aceptada. Para confirmar debe abonar el siguiente importe en concepto de seña:'.$initialDeposit; //pasar datos de reserva. 
